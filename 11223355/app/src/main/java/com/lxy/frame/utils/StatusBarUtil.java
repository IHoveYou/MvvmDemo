...
import com.lxy.frame.widget.StatusBarView;
...
public class StatusBarUtil {
    ...
    public static void setStatusColor(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            setColor(activity, AppHelper.getColor(R.color.maincolor), DEFAULT_STATUS_BAR_ALPHA);
        } else {
            setColor(activity, AppHelper.getColor(R.color.maincolor), DEFAULT_STATUS_BAR_ALPHA);
        }
    }
    ...
    public static void setStatusColor(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            setColor(activity, AppHelper.getColor(color), DEFAULT_STATUS_BAR_ALPHA);
        } else {
            setColor(activity, AppHelper.getColor(R.color.black), DEFAULT_STATUS_BAR_ALPHA);
        }
    }
    ...
    public static void immersiveStatusBar(Window window) {
        immersiveStatusBar(window, DEFAULT_STATUS_BAR_ALPHA);
    }
